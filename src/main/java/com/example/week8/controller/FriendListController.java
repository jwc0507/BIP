...
public class FriendListController {
    ...
    public ResponseDto<List<FriendInfoResponseDto>> getFriendList(HttpServletRequest request) { return friendService.getFriendList(request); }
    ...
    public ResponseDto<FriendInfoResponseDto> addFrinedByNickname(@RequestBody FriendAdditionRequestDto friendAdditionRequestDto, HttpServletRequest request){
    ...
    public ResponseDto<FriendInfoResponseDto> addFriendByPhoneNumber(@RequestBody FriendAdditionRequestDto friendAdditionRequestDto, HttpServletRequest request) {
        return friendService.addFriendByPhoneNumber(friendAdditionRequestDto, request);
    }

    //친구 삭제
    @RequestMapping(value = "api/friends/{memberId}")
    public ResponseDto<String> deleteFriend(@PathVariable Long memberId, HttpServletRequest request){
